...
export const Orrery = () => {
  ...
  const [selected, setSelected] = useState<string | null>(
    config.focus.default.selected.objectId
  );
  const [hovered, setHovered] = useState<string | null>(
    config.focus.default.hovered.objectId
  );
    ...
    <>
      <MultipleContextProvider
        contexts={[
          ...
          {
            context: ImpactParamsContext,
            value: { params: impactParams, setImpactParams: setImpactParams },
          },
        ]}
      >
        <ForceLandscape>
